...
-}
insert : ( Int, Int ) -> a -> Grid a -> Result Error (Grid a)
...
-}
update : ( Int, Int ) -> (Maybe a -> Result () (Maybe a)) -> Grid a -> Result Error (Grid a)
...
`NotSuccessful` error.
-}
remove : ( Int, Int ) -> Grid a -> Result Error (Grid a)
...
-}
member : ( Int, Int ) -> Grid a -> Result Error Bool
